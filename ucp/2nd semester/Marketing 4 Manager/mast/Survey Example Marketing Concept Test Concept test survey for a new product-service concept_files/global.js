...
function cyopDummyResults (tableID, data) {
        ...
        colData += "<TR><TD align=\"right\" class=\"special\" style=\"font-size:7pt;\">Note: Dummy Data</TD></TR>";
        colData += "</TABLE>";
...
function ajaxLinkForControl(controlID, url) {
  ...
  dojo.io.bind({
        ...
        load:function(type, data, event) {
          mycontainer.value = stringTrim(data) + mycontainer.value.replace(/Please wait\.\.\./i,"");
        }
  });
  // Update the Status Container
