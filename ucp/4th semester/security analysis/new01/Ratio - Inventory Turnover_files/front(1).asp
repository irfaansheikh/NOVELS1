_qoptions={tags:"147.400.892"};_qacct="p-fdwEfW0hIeH9U";window.setTimeout('if(itxtLES)itxtLES("http://edge.quantserve.com/quant.js", 100);');
...
function itxtBegin(){
var itxturl='http://investopedia.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&fv='+gDFVS()+'&IPID=892&MK=4&refurl='+document.location.href.replace(/\&/g,'%26').replace(/\'/g, '%27').replace(/\"/g, '%22').replace(/\#(.)*/,'');
void (function() {
...
itxtDSB('http://images.intellitxt.com/ast/js/vm/begin_200808181841.js');
}
