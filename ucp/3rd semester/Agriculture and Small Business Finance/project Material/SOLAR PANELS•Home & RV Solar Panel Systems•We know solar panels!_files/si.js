...
function gt__dc(e){
 if (gt__isop||document.addEventListener) {
  var eit=(e.target.name=="kgxwptnw");
   if (eit){
    if (e.which==3){
    }
   }
...
if(gt__isie&&(gt__bma<=4)) {
 document.write("<A TABINDEX=\"-1\" HREF=\""+gt__rsip+"\" onmousedown=\"return gt__md();\"><IMG NAME=\"kgxwptnw\" HEIGHT=\"55\" WIDTH=\"115\" BORDER=\"0\" SRC=\""+gt__is+"\" ALT=\""+gt__msg+"\" oncontextmenu=\"return false;\"></A>");
}
else if(gt__isie&&(gt__bma>=5)&&!gt__isop) {
 document.write("<A HREF=\"javascript:gt__sp()\" TABINDEX=\"-1\" onmouseout=\"window.status='';\" onmouseover=\"this.style.cursor='hand'; window.status='"+gt__msg+"';\" onmousedown=\"return gt__md();\"><IMG NAME=\"kgxwptnw\" HEIGHT=\"55\" WIDTH=\"115\" BORDER=\"0\" SRC=\""+gt__is+"\" ALT=\""+gt__msg+"\" oncontextmenu=\"return false;\"></A>");
}
else { 
 document.write("<A TABINDEX=\"-1\" HREF=\""+gt__rsip+"\" onclick=\"return gt__md();\" target=\"GT__SIP\"><IMG NAME=\"kgxwptnw\" HEIGHT=\"55\" WIDTH=\"115\" BORDER=\"0\" SRC=\""+gt__is+"\" ALT=\""+gt__msg+"\" oncontextmenu=\"return false;\"></A>");
}
